...
public class DbInitializer
{
  ...
  public async Task Seed()
  {
    ...
    if (!_context.Categories.Any())
    {
      ...
      List<CategoryCreateRequest> listCategoryEntity = _mapper.Map<List<CategoryFromCSV>, List<CategoryCreateRequest>>(listCategory);
      await _categoryService.SeedData(listCategoryEntity);
    }

    if (!_context.Posts.Any())
    {
      List<PostFromCSV> listPost = _postService.GetData(GetResourceDirectoryPath() + "/resources/post_10000.csv");
