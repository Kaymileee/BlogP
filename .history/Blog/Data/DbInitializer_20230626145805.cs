...
public class DbInitializer
{
  ...
  public async Task Seed()
  {
    ...
    foreach (Category category in listCategoryEntity)
    {
      listCategoryId.Add(category.CategoryId);
    }
    List<PostFromCSV> listPost = _postService.GetData(GetResourceDirectoryPath() + "/resources/post.csv");
    ...
    {
      await _postService.SeedData(listPostEntity, user1.UserId, listCategoryId);
    }
    await _context.SaveChangesAsync();
