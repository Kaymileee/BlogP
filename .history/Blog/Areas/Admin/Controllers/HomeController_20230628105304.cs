...
namespace Blog.Areas.Admin.Controllers
{
  ...
  public class HomeController : Controller
  {
    ...
    public HomeController(ApplicationDBContext db, IMapper mapper, ITagService tagService)
    {
      _db = db;
      _mapper = mapper;
    ...
    {
      var tags = await _db.Tags.Take(10).ToListAsync();
      return PartialView("~/Areas/Admin/Views/Shared/_TagSidebar.cshtml", tags);
    ...
    {
      var list = _tagService.GetAllTag();
      return Ok(list);
    }
